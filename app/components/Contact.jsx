    ...
    return (
        <motion.div
            ...
            <motion.p
               ...
               Have an idea or need a developer for your next project? I’d love to hear from you! Feel free to reach out to me using the form below or through my social media profiles.
            </motion.p>
            ...
            <motion.form
                ...
                rows='6' placeholder='Enter your message' required
                    className='w-full p-4 outlinne-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6  dark:bg-darkHover/30 dark:border-white/90' name='message'></motion.textarea>
