  ...
  return (
    <motion.div
      ...
      <motion.p
        ...
        From frontend UI to backend APIs, I build complete solutions using Reactjs and Nodejs.
        SEO-friendly, fast-loading websites with SSR & ISR.
        Mobile application for Android and iOS both. 
        Chat apps, live updates, and notifications using Socket.IO.
        Secure transactions with Razorpay, Stripe, and more.
