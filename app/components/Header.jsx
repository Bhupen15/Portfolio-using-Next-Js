...
const Header = () => {
  return (
    <div className='w-11/12  mx-auto text-center h-screen flex flex-col items-center justify-center gap-4 '>
      ...
      >
        <Image src={assets.profile_img} alt='' className='rounded-full w-32 mt-20' priority/> 
      </motion.div>
      ...
      <motion.h3
       ...
       className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo '
        ...
        Hi, I’m a passionate MERN Stack, Next.js and React Native Developer with expertise in building high-performance web applications. Explore my work and let's build something amazing together!
